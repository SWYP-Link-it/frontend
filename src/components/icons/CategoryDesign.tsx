...
export const CategoryDesign = ({ size = 16, className }: SVGProps) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <circle cx="20" cy="14" r="3" fill="#E9EAEB" />
      <circle cx="32" cy="16" r="3" fill="#E9EAEB" />
      <circle cx="14" cy="24" r="3" fill="#E9EAEB" />
    </svg>
  );
};
