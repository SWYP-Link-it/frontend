    ...
    >
      ...
      <defs>
        <mask id="dots-cutout">
          ...
          {/* 구멍 뚫을 부분 */}
          <circle cx="5.96468" cy="10.0006" r="1.07186" fill="black" />
          <circle cx="9.99984" cy="10.0006" r="1.07186" fill="black" />
          <circle cx="14.0347" cy="10.0006" r="1.07186" fill="black" />
        </mask>
      </defs>
    </svg>
  );
