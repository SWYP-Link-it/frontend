  ...
  return (
    <div className="relative">
      <textarea
        ...
        className="min-h-[100px] w-full resize-none rounded-xl border border-gray-100 bg-white p-6 text-sm text-gray-700 transition-all placeholder:text-gray-300 focus:ring-2 focus:ring-blue-100 focus:outline-none"
      />
      {value && (
